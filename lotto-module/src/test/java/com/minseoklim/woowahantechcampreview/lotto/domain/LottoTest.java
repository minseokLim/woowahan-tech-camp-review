...
import static com.minseoklim.woowahantechcampreview.lotto.domain.Lotto.*;
...
class LottoTest {
    private static final Purchase DEFAULT_PURCHASE = new Purchase(1000, 1, 1L, List.of(Set.of(1, 2, 3, 4, 5, 6)));
